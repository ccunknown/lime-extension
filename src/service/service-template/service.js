...
class Service extends EventEmitter {
  ...
  */
  ...
  // addObject(config) {
  //   console.log(`[${this.constructor.name}]`, `addObject() >> `);
  ...
  //         resolve(id ? this.objects.get(id) : this.mapToObject(this.objects));
  //       else if (id) {
  //         const object = this.objects.get(id);
  ...
  //         const objectList = this.mapToObject(this.objects);
  //         const json = [];
  ...
  //       Promise.resolve()
  //         .then(() => this.getDirectorySchema(serviceConfig.directory, options))
  //         .then((objectDir) =>
