(function () {
  d3.timeline = function() {
    ...
    function timeline (gParent) {
      ...
      gParent = Object.values(gParent).reverse();
      console.log(`gParent:`, gParent);
      console.log(`gParent[0]:`, gParent[0]);
      var gParentSize = gParent[0][0].getBoundingClientRect();
      // var gParentSize = `400px`;
      ...
      g.each(function(d, i) {
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            .append(function(d, i) {
                return document.createElementNS(`NS`, "display" in d? d.display:display);
            })
            .attr("x", getXPos)
